...
describe("GET /api/teachers", () => {
  ...
  it("should return 404 for non-existent teacher ID", async () => {
...
describe("GET /api/scheduled-classes", () => {
  it("should return all scheduled classes sorted by start time", async () => {
  ...
  it("should return a single scheduled class by ID", async () => {
    const classId = 9
  ...
  it("should return 404 for non-existent scheduled class ID", async () => {
