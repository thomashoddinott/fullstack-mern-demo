  ...
  return (
    <div className="flex flex-col items-center py-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl">
        ...
        {classes &&
          classes.map((cls, i) => (
            <div key={i} className="bg-white rounded-xl shadow p-6 flex flex-col justify-between">
              <div>
                <h2 className="text-xl font-semibold mb-3 text-gray-800">{cls.name}</h2>
                <p className="text-gray-600 mb-6 leading-relaxed">{cls.description}</p>
              </div>
