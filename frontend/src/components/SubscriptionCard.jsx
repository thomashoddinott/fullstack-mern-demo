  ...
  return (
    <div className={rootClass} style={colors?.rootStyle}>
      <div className="subscription-left-ui">
        <h2 className="subscription-title-ui">{planData?.label ?? "Premium Membership"}</h2>
        <p className="subscription-subtitle-ui">Unlimited access to all classes and facilities</p>
        ...
        <div className="subscription-stats-ui">
          ...
          <div>
            ...
            <p className="subscription-label-ui">{planData?.billing ?? "Monthly"}</p>
          </div>
        </div>
      </div>
